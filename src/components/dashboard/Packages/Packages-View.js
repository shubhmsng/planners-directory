                ...
                <div className="card-body">
                  <div className="m-0">
                    ...
                    <h6 className="text-muted d-flex justify-content-between">
                      ...
                      {data.p1Description && (
                        <b
                          className={
                            "counter " +
                            (data.p1IsEnable && data.p1Description.length <= 100
                              ? "text-danger"
                              : "")
                          }
                        >
                          {data.p1Description ? data.p1Description.length : 0}
                          /500 chars
                        </b>
                      )}
                    </h6>
                    <textarea
                      ...
                      defaultValue={""}
                    />
                    <p className="text-danger m-h-23">
                      {fieldsChecks.p1Description &&
                        "Max of 500 and Min of 100 chars is required."}
                    </p>
                  </div>
                  <div className="border-divider">
                    <div className="m-t-20">
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p1Ofr1 && data.p1Offer1.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p1Offer1 ? data.p1Offer1.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
                      ...
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox  d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p1Ofr2 && data.p1Offer2.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p1Offer2 ? data.p1Offer2.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
                      ...
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p1Ofr3 && data.p1Offer3.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p1Offer3 ? data.p1Offer3.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
                  ...
                  <div className="m-0">
                    ...
                    <h6 className="text-muted d-flex justify-content-between">
                      ...
                      <b
                        className={
                          "counter " +
                          (data.p2IsEnable && data.p2Description.length <= 100
                            ? "text-danger"
                            : "")
                        }
                      >
                        {data.p2Description ? data.p2Description.length : 0}/500
                        chars
                      </b>
                    </h6>
                    <textarea
                      ...
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p2Ofr1 && data.p2Offer1.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p2Offer1 ? data.p2Offer1.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
                      ...
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p2Ofr2 && data.p2Offer2.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p2Offer2 ? data.p2Offer2.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
                      ...
                      <div className="text-muted mb-2">
                        <div className="custom-control d-inline custom-checkbox d-flex justify-content-between">
                          ...
                          <b
                            className={
                              "counter " +
                              (data.p2Ofr3 && data.p2Offer3.length <= 100
                                ? "text-danger"
                                : "")
                            }
                          >
                            {data.p2Offer3 ? data.p2Offer3.length : 0}/500 chars
                          </b>
                        </div>
                      </div>
                      <textarea
